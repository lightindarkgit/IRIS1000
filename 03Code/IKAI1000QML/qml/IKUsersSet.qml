...
Rectangle {
    ...
    property var initUserVerifyText:qsTr("虹膜或卡")
    ...
    Rectangle{
        ...
        Button {
            ...
            onClicked:{
                ...
                {
                    faceVerifyImg1.source = "qrc:///image/userlist/element_select_off.png"
                    m_faceVerifyBtn1_img = false;
                }
                else
                {
                    faceVerifyImg1.source = "qrc:///image/userlist/element_select_on.png"
    ...
    IKIdentMode{
        id:userVerifyDialog
        currentVerify: verifySet.initUserVerifyText
    }    
    IKIdentMode{
