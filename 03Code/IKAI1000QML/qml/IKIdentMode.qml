...
Rectangle {
    ...
    signal identModeItemClicked(bool res,var name)
    Component.onCompleted: {
        identModeItemClicked.connect(iKManage.idenButnChange);
        identModeItemClicked.connect(ikSwite.idenButnChange);
    }
    ...
    Rectangle{
        ...
        RowLayout {
            ...
            RadioButton {
                //                objectName: radio1
                id: radioButton1
                checked: currentVerify === qsTr("虹膜或卡") ? true : false
            ...
            RadioButton {
                id: radioButton2
                 checked: currentVerify === qsTr("虹膜和卡") ? true : false
                anchors.left: rowLayout.left
            ...
            RadioButton {
                id: radioButton3
                checked: currentVerify === qsTr("只有虹膜") ? true : false
                anchors.left: rowLayout.left
            ...
            RadioButton {
                id: radioButton4
                checked: currentVerify === qsTr("只有卡") ? true : false
                anchors.left: rowLayout.left
        ...
        Button {
            ...
            onClicked: {
                emit: identModeItemClicked(false,currentName)
        ...
        Button {
            ...
            onClicked: {
                emit: identModeItemClicked(true,currentName)
