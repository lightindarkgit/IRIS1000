...
Rectangle
{
    ...
    function setDate(year, month, day)
    {
        ...
        showMonth = monthData[curMonth] + "月"
        showDay = dayData[curDay] + "日"
        yearPv.currentIndex = curYear
        monthPv.currentIndex = curMonth
        dayPv.currentIndex = curDay
        currentData = yearData[curYear] + "-" + monthData[curMonth] + "-" + dayData[curDay]
        var locale= Qt.locale()
        var tmp = Date.fromLocaleString(locale, currentData, "yyyy-MM-dd").toLocaleString(Qt.locale("zh_CN"), "ddd")
        showDate.text = showYear + showMonth + showDay + "   " + tmp
    }
}
