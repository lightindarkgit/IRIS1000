...
Rectangle {
    ...
    Rectangle{
        ...
        Image {
            ...
            width: 64
            height:64
            source: "qrc:///res/image/topbar/glasses.png"
        }
        ...
        Image {
            ...
            width: 64
            height:64
            source: "qrc:///res/image/topbar/contactlenses.png"
        }
        ...
        Image {
            ...
            width: 64
            height:64
            source: "qrc:///res/image/topbar/eye.png"
        }
    }
    ...
    ProgressBar{
        ...
        style: ProgressBarStyle{
            id: progressStyle2;
            background: Rectangle{
                color: m_Enroll ? "#ffffff" : (qPro.msgText === "请退后"? "#5aa5e6":(qPro.msgText === "请靠近"? "#d8293b":"green"))
                opacity: 0.7
            }
            progress: Rectangle{
                id: proRec2
    ...
    Button{
        ...
        Button{
            ...
            style: ButtonStyle{
                background: Rectangle{
                    ...
                    implicitHeight: 96
                    color: "#262626"
                    property string nomerPic: "qrc:///res/image/home/lock.png"
                    property string activePic: "qrc:///res/image/home/lock_hover.png"
        ...
        Button{
            ...
            style: ButtonStyle{
                background: Rectangle{
                    ...
                    implicitHeight: 96
                    color: "#262626"
                    property string nomerPic: "qrc:///res/image/home/management.png"
                    property string activePic: "qrc:///res/image/home/management_hover.png"
                    Image {
                        id: btnimagepag
        ...
        Button{
            ...
            opacity:1
            signal itemClicked()
            property bool changeFaceImage:false
            ...
            style: ButtonStyle{
                background: Rectangle{
                    ...
                    implicitHeight: 80
                    radius: 10
                    property string nomerFacePic: "qrc:///res/image/other/face_normal.png"
                    property string activeFacePic: "qrc:///res/image/other/face_active.png"
                    property string nomerIrisPic: "qrc:///res/image/other/iris_normal.png"
                    property string activeIrisPic: "qrc:///res/image/other/iris_active.png"
