    ...
    Button
    {
        ...
        style: ButtonStyle{
            background: Rectangle{
                ...
                implicitHeight: 104
                color:"#303334"
                property string nomerPic: "qrc:///res/image/setImage/basic.png"
                property string activePic: "qrc:///res/image/setImage/basic_hover.png"
                Image {
    ...
    Button
    {
        ...
        style: ButtonStyle{
            background: Rectangle{
                ...
                implicitHeight: 110
                color:"#303334"
                property string nomerPic: "qrc:///res/image/setImage/interface.png"
                property string activePic: "qrc:///res/image/setImage/interface_hover.png"
                Image {
                    source: control.pressed? activePic : nomerPic
                }
            }
    ...
    Button
    {
        ...
        style: ButtonStyle{
            background: Rectangle{
                ...
                implicitHeight: 110
                color:"#303334"
                property string nomerPic: "qrc:///res/image/setImage/verify.png"
                property string activePic: "qrc:///res/image/setImage/verify_hover.png"
                Image {
                    source: control.pressed? activePic : nomerPic
                }
            }
    ...
    Button
    {
        ...
        style: ButtonStyle{
            background: Rectangle{
                ...
                implicitHeight: 121
                color:"#303334"
                property string nomerPic: "qrc:///res/image/setImage/communication.png"
                property string activePic: "qrc:///res/image/setImage/communication_hover.png"
                Image {
                    source: control.pressed? activePic : nomerPic
                }
            }
    ...
    Button
    {
        ...
        style: ButtonStyle{
            background: Rectangle{
                ...
                implicitHeight: 108
                color:"#303334"
                property string nomerPic: "qrc:///res/image/setImage/data.png"
                property string activePic: "qrc:///res/image/setImage/data_hover.png"
                Image {
                    source: control.pressed? activePic : nomerPic
                }
            }
    ...
    Button
    {
        ...
        style: ButtonStyle{
            background: Rectangle{
                ...
                implicitHeight: 114
                color:"#303334"
                property string nomerPic: "qrc:///res/image/setImage/init.png"
                property string activePic: "qrc:///res/image/setImage/init_hover.png"
                Image {
                    source: control.pressed? activePic : nomerPic
                }
            }
